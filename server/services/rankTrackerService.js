...
export async function rankTracker(keyword, targetDomain) {
    ...
    try {
        ...
        page.setDefaultNavigationTimeout(45000); // Set navigation timeout to 60 seconds
        ...
        try {
            ...
            if (btn) {
                await btn.click();
                await page.waitForTimeout(1500); // Wait for 2 seconds after clicking
            }
        } catch {}
        ...
        for (let gPage = 0; gPage < 5; gPage++) {
            await page.goto(
                `https://www.google.com/search?q=${encodeURIComponent(keyword)}&start=${gPage * 10}&num=10&h1=en&gl=us`,
            ...
            for (const r of pageResults) {
                ...
                if (found) break;
                await page.waitForTimeout(2000 + Math.random() * 2000); // Random delay between 2-4 seconds
            }
            // 6. Finalization : close browser and extracted data return
            await browser.close();
