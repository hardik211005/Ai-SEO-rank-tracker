...
export async function scrapeUrl(url) {
    ...
    try {
        ...
        const scrapedData = await page.evaluate(() => {
            const getMeta = (name) => {
                // ✅ fix 2: missing quote added
                const el = document.querySelector(`meta[name="${name}"]`) || 
                           document.querySelector(`meta[property="${name}"]`);
                // ✅ fix 3: trailing space removed
            ...
            const twitterCard = getMeta("twitter:card"); // ✅ typo fix: "twitte:card"
            ...
            // ✅ fix 1: documentElement not document.document.Element
        ...
        // ✅ fix 5: return karna zaroori tha
